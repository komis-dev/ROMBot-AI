...
openai.api_key = "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"
...
def get_answer_from_embeddings(input):
    ...
    # If no matching embedding is found, use OpenAI API to generate response
        ...
        messages = [
            ...
            {"role": "user", "content": f"Hi, who is an expert on the ROM Global project based on this information: {input}"}
        ]
